...
class FeatureListParserTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testParseData()
    {
        ...
        // DBA level1
        $this->assertTrue(isset($data['DBA']['constraints']['antecedent']['level1']));

        // DBA level2
        $this->assertTrue(isset($data['DBA']['constraints']['antecedent']['level2']));

        // DBA level3
        $this->assertTrue(isset($data['DBA']['constraints']['antecedent']['level3']));

        // DBA level1 constraint
        $this->assertTrue(isset($data['DBA']['constraints']['antecedent']['level1']['Conjunction']));

        // DBA level1 constraints
        $this->assertEquals(4, count($data['DBA']['constraints']['antecedent']['level1']));

        // DBA level1 constraint allowed
        $this->assertEquals(true, $data['DBA']['constraints']['antecedent']['level1']['Conjunction']['allowed']);
    }
