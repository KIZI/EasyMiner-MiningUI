var RulesParser = new Class({
	...
	parseIM: function (IM) {
		...
		return new InterestMeasureAR(IM.name, IMPrototype.getLocalizedName(), IMPrototype.getExplanation(), IMPrototype.getThresholdType(), IMPrototype.getCompareType(), IMPrototype.getFields(), IMPrototype.getStringHelper(), IMPrototype.calculation, IMPrototype.getDefault(), IMPrototype.getRequired(), IM.fields.value, null);
	},
