...
use IZI\FieldGroupConfig\CoefficientType;
use IZI\FieldGroupConfig\FieldGroupConfigCoefficient;
...
class FieldGroupConfigCoefficientTest extends PHPUnit_Framework_TestCase
{
    ...
    /**
     * @expectedException IZI\Exception\InvalidCoefficientException
     */
